    ...
    void Update()
    {
        if (inBuyZone && Input.GetKeyDown(KeyCode.E))
        {
            if (LevelManager.instance.currentCoins >= itemCost)
            {
                ...
                if (isHealthRestore) PlayerHealthController.instance.HealPlyaer(PlayerHealthController.instance.maxHealth);

                if (isHealthUpgrade) PlayerHealthController.instance.IncreaseMaxHealth(healthUpgradeAmount);
                ...
                if (isWeapon)
                {
                    ...
                    PlayerController.instance.currentGun = PlayerController.instance.avaliableGuns.Count - 1;
